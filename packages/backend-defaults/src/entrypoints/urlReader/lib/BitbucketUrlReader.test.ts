...
'foo',
{status: 200,
headers: {"ETag":"etag-value","Last-Modified":"ew Date('2020-01-01T00:00:00Z').toUTCString("},
});
          },
        ),
      );
...
repoBuffer,
{status: 200,
headers: {"Content-Type":"application/zip","content-disposition":"attachment; filename=backstage-mock-12ab34cd56ef.tar.gz"},
})},
        ),
        http.get(
